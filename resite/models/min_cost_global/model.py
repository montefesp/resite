...
def build_model_gurobipy(resite, params: Dict):
    ...
    from resite.models.gurobipy_utils import minimize_total_cost, capacity_bigger_than_existing, \
        infeed_lower_than_potential, supply_bigger_than_demand_regional, supply_bigger_than_demand_global
...
def build_model_pyomo(resite, params: Dict):
    ...
    model.generation_check_global = Constraint(np.arange(len(time_slices)), rule=generation_check_global_rule)
